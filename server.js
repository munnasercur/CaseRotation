...
const ANNOUNCEMENT_MESSAGE =
  ...
  "ฟีเจอร์ใหม่ / เปลี่ยนแปลง:\n" +
  "• จำหน่ายผู้ป่วยต้องระบุชื่อเสมอ: พิมพ์ 'เตียง ชื่อ d/c' เช่น '3 มาโนชญ d/c' (ห้ามพิมพ์แค่ '3 d/c' เฉยๆ แล้ว) — กันจำหน่ายผิดคนเวลาเตียงถูกใช้ซ้ำ พิมพ์ต่อกันหลายเตียงได้ เช่น '3 มาโนชญ d/c 5 สมศรี d/c'\n" +
  "• จำหน่ายเสร็จแล้วจะบอกด้วยว่าเจ้าของเคสเหลือเคส Active กี่เคส\n" +
  "• /allcase และ /summary ตอนนี้เหมือนกัน: แสดงเคส Active ทั้งหมด แยกตามเจ้าของเคส ไม่จำกัดแค่ 3 วันอีกต่อไป\n" +
  "• คำสั่งใหม่ /todaycase → ดูเคสที่รับวันนี้ทั้งหมด แยกตามเจ้าของเคส\n" +
  "• /allcase /summary /todaycase ตอนนี้จะบอกคิวถัดไปด้วยทุกครั้ง\n\n" +
